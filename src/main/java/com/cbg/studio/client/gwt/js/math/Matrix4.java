...
public class Matrix4 extends JavaScriptObject {
    ...
    public final native Matrix4 set(double n11, double n12, double n13,
            double n14, double n21, double n22, double n23, double n24,
            double n31, double n32, double n33, double n34, double n41,
            double n42, double n43, double n44)/*-{
    ...
    /**
     * watch out ,this is not work as same as old setRotationFromEuler. MAKE
     * means just create a matrix form euler. so postion data which set before
     * is gone. so if you have to call makeRotationFromEuler() first and
     * setPosition() later. when update your code.
     * 
     * @param euler
     * @return
     */
    ...
    public final native Matrix4 multiplyToArray(Matrix4 a, Matrix4 b,
            JsArrayNumber r)/*-{
    ...
    public final native JsArrayNumber flattenToArrayOffset(JsArrayNumber flat,
            int offset)/*-{
    ...
    /**
     * @deprecated must use makeRotationFromQuaternion MAKE clear all postion
     *             data.
     */
    ...
    public final native Matrix4 compose(Vector3 position,
            Quaternion quaternion, double scale)/*-{
                                                return this.compose(position,quaternion,scale);
                                                }-*/;

    public final native Matrix4 decompose(Vector3 position,
            Quaternion quaternion, double scale)/*-{
                                                return this.decompose(position,quaternion,scale);
                                                }-*/;

    public final native Matrix4 makeFrustum(double left, double right,
            double bottom, double top, double near, double far)/*-{
                                                               return this.makeFrustum(left,right,bottom,top,near,far);
                                                               }-*/;

    public final native Matrix4 makePerspective(double fov, double aspect,
            double near, double far)/*-{
                                    return this.makePerspective(fov,aspect,near,far);
                                    }-*/;

    public final native Matrix4 makeOrthographic(double left, double right,
