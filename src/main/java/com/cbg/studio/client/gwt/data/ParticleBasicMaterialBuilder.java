...
import com.cbg.studio.client.gwt.js.materials.ParticleBasicMaterial;
...
public class ParticleBasicMaterialBuilder extends JavaScriptObject {
    ...
    public final static ParticleBasicMaterialBuilder create() {
        return (ParticleBasicMaterialBuilder) ParticleBasicMaterialBuilder
                .createObject();
    }
    ...
    public final native ParticleBasicMaterialBuilder transparent(
            boolean transparent)/*-{
                                this["transparent"]=transparent;
                                return this;
                                }-*/;

    public final native ParticleBasicMaterialBuilder sizeAttenuation(
