package com.cbg.studio.client.gwt;
...
public class JSONModelFile extends JavaScriptObject {
    ...
    public native final void setMorphTargets(
            JsArray<JavaScriptObject> morphTargets)/*-{
    ...
    public native final void setMorphColors(
            JsArray<JavaScriptObject> morphColors)/*-{
                                                  this["morphColors"]=morphColors;
                                                  }-*/;

    public final void setSkinIndicesAndWeights(JsArray<Vector4> indices,
            JsArray<Vector4> weights) {
        JsArrayNumber indicesArray = (JsArrayNumber) JsArrayNumber
                .createArray();
        for (int i = 0; i < indices.length(); i++) {
            indicesArray.push(indices.get(i).getX());
            indicesArray.push(indices.get(i).getY());
        }
        JsArrayNumber weightsArray = (JsArrayNumber) JsArrayNumber
                .createArray();
    ...
    public final void setGeometryUvs(JsArray<JsArray<JsArray<Vector2>>> uvss) {
        @SuppressWarnings("unchecked")
        JsArray<JsArrayNumber> uvArray = (JsArray<JsArrayNumber>) JsArray
                .createArray();
    ...
    public final JSONModelFile clone() {
        ...
        if (this.getUvs() != null) {
            ...
            for (int i = 0; i < valuesUvs.length(); i++) {
                ...
                JsArrayNumber array = (JsArrayNumber) JavaScriptObject
                        .createArray();
