...
public class Uint8Array extends IntBasedTypedArray<Uint8Array> {
    ...
    /**
     * Creates a new instance of the {@link Uint8Array} using the given
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * @param buffer
     *            the underlying {@link ArrayBuffer} of the newly created
     *            {@link TypedArray}.
     * @return the created {@link Uint8Array} or null if it isn't supported by
     *         the browser.
     */
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Uint8Array} is created using the byteOffset to specify the
     * starting point (in bytes) of the {@link Uint8Array} relative to the
     ...
     * @return the newly created {@link Uint8Array} or null if it isn't
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Uint8Array} is created using the byteOffset and length to
     * specify the start and end (in bytes) of the {@link Uint8Array} relative
    ...
    /**
     * Creates a new instance of the {@link Uint8Array} of the given length in
    ...
    /**
     * Creates a new instance of the {@link Uint8Array} of the length of the
     * given array in values. The values contained in the given array are set to
     * the newly created {@link Uint8Array}.
     * 
     * @param array
    ...
    /**
     * Creates a new instance of the {@link Uint8Array} of the same length (in
     * values) as the given {@link Uint8Array} using a new ArrayBuffer. The new
     ...
     *            (multiple of the value length of this {@link TypedArray})
     * @param length
     *            the length of the {@link Uint8Array} in vales.
     * @return the newly created {@link Uint8Array}.
     */
    private static native Uint8Array createImpl(ArrayBuffer buffer,
