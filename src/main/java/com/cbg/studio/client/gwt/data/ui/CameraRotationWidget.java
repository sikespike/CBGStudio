...
public class CameraRotationWidget extends Composite {
    ...
    private static CameraMoveWidgetUiBinder uiBinder = GWT
            .create(CameraMoveWidgetUiBinder.class);

    interface CameraMoveWidgetUiBinder extends
            UiBinder<Widget, CameraRotationWidget> {
    }
    ...
    @UiField
    Label xl, xv, yl, yv, zl, zv;
    @UiField
    Button foward, left, reset, right, back, up, down;
