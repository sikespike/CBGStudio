...
public class ImageUtils extends JavaScriptObject {
    ...
    public static final native Texture loadTexture(String url,
            JavaScriptObject mapping, ImageUtilsLoadHandler handler)/*-{
                                                                    if(handler){
                                                                    return $wnd.THREE.ImageUtils.loadTexture(url,mapping,function ( texture ) {
                                                                    handler.@com.cbg.studio.client.gwt.js.extras.ImageUtils$ImageUtilsLoadHandler::onLoad(Lcom/google/gwt/core/client/JavaScriptObject;)(texture);
                                                                    },function ( onError ) {
                                                                    handler.@com.cbg.studio.client.gwt.js.extras.ImageUtils$ImageUtilsLoadHandler::onError(Lcom/google/gwt/dom/client/NativeEvent;)(onError);
                                                                    });
                                                                    }else{
    ...
    public static final native CompressedTexture loadCompressedTexture(
            String url, JavaScriptObject mapping, ImageUtilsLoadHandler handler)/*-{
                                                                                if(handler){
    ...
    public static final native CompressedTexture loadCompressedTextureCube(
            JsArrayString array, JavaScriptObject mapping,
            ImageUtilsLoadHandler handler)/*-{
                                          if(handler){
    ...
    public static final native CompressedTexture loadDDSTexture(String url,
            JavaScriptObject mapping, ImageUtilsLoadHandler handler)/*-{
                                                                    if(handler){
     ...
     * @return
     */
    public static final native JavaScriptObject parseDDS(
            JavaScriptObject buffer, boolean loadMipmaps)/*-{
     ...
     * @return
     */
    public static final native CanvasElement getNormalMap(ImageElement image,
            int depth)/*-{
                      return $wnd.THREE.ImageUtils.getNormalMap(image,depth);
                      }-*/;

    public static final native DataTexture generateDataTexture(int width,
