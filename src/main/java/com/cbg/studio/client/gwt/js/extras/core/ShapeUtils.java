...
public class ShapeUtils {
    ...
    public final native JavaScriptObject removeHoles(JsArray<Vector2> contour,
            JsArray<JsArray<Vector2>> holes)/*-{
                                            return this.removeHoles(contour,holes);
                                            }-*/;

    public final native JavaScriptObject triangulateShape(
            JsArray<Vector2> contour, JsArray<JsArray<Vector2>> holes)/*-{
                                                                      return this.triangulateShape(contour,holes);
                                                                      }-*/;

    public final native JavaScriptObject triangulate2(JsArray<Vector2> pts,
            JsArray<JsArray<Vector2>> holes)/*-{
    ...
    public final native double b3(double t, double p0, double p1, double p2,
            double p3)/*-{
