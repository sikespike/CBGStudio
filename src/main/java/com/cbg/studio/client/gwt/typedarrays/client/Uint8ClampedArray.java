...
/**
 * {@link TypedArray} that contains 8 Bit unsigned integer values. The
 * difference to {@link Uint8ClampedArray} is when setting values: The
 * Uint8ClampedArray uses clamping. Values that are >255 will be set to 255 and
 * values <0 will be set to 0 instead of calculating the effective value based
 * on a modulo operation.
 * 
 */
public class Uint8ClampedArray extends IntBasedTypedArray<Uint8ClampedArray> {
    ...
    /**
     * Creates a new instance of the {@link Uint8ClampedArray} using the given
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * @param buffer
     *            the underlying {@link ArrayBuffer} of the newly created
     *            {@link TypedArray}.
     * @return the created {@link Uint8ClampedArray} or null if it isn't
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Uint8ClampedArray} is created using the byteOffset to specify
     * the starting point (in bytes) of the {@link Uint8ClampedArray} relative
     * to the beginning of the underlying {@link ArrayBuffer}. The byte offset
     * must match (multiple) the value length of this {@link TypedArray}.
     * 
     ...
     * @return the newly created {@link Uint8ClampedArray} or null if it isn't
     *         supported by the browser.
     */
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Uint8ClampedArray} is created using the byteOffset and length
     * to specify the start and end (in bytes) of the {@link Uint8ClampedArray}
     * relative to the beginning of the underlying {@link ArrayBuffer}. The byte
     * offset must match (multiple) the value length of this {@link TypedArray}.
    ...
    /**
     * Creates a new instance of the {@link Uint8ClampedArray} of the given
     * length in values. All values are set to 0.
     * 
     * @param length
    ...
    /**
     * Creates a new instance of the {@link Uint8ClampedArray} of the length of
     * the given array in values. The values contained in the given array are
     * set to the newly created {@link Uint8ClampedArray}.
     * 
     * @param array
    ...
    /**
     * Creates a new instance of the {@link Uint8ClampedArray} of the same
     * length (in values) as the given {@link Uint8ClampedArray} using a new
     * ArrayBuffer. The new {@link TypedArray} is initialized with the values of
     * the given {@link TypedArray}. If necessary the values are converted to
     * the value type of the new {@link TypedArray}.
     * 
     * @param array
    ...
    /**
     * Checks if the Browser supports the {@link Uint8ClampedArray}. There's a
     * special check, as not all browsers that do support {@link TypedArray}
     * support {@link Uint8ClampedArray} too. Thats because
     * {@link Uint8ClampedArray} is a late addition to the specification.
     * 
     * @return true, if Uint8ClampedArray is supported, false otherwise.
     */
    public static boolean isSupported() {
        // use the compile time check of TypedArray. If TypedArray isn't
        // supported, Uint8ClampedArray
     ...
     *            (multiple of the value length of this {@link TypedArray})
     * @param length
     *            the length of the {@link Uint8ClampedArray} in vales.
     * @return the newly created {@link Uint8ClampedArray}.
     */
    private static native Uint8ClampedArray createImpl(ArrayBuffer buffer,
    ...
    /**
     * Checks at runtime if the Browser supports the {@link Uint8ClampedArray}.
     * There's a special check, as not all browsers that do support
     * {@link TypedArray} support {@link Uint8ClampedArray} too. Thats because
     * {@link Uint8ClampedArray} is a late addition to the specification.
     * 
     * @return true, if Uint8ClampedArray is supported, false otherwise.
     */
