...
public class Uint32Array extends IntBasedTypedArray<Uint32Array> {
    ...
    /**
     * Creates a new instance of the {@link Uint32Array} using the given
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * @param buffer
     *            the underlying {@link ArrayBuffer} of the newly created
     *            {@link TypedArray}.
     * @return the created {@link Uint32Array} or null if it isn't supported by
     *         the browser.
     */
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Uint32Array} is created using the byteOffset to specify the
     * starting point (in bytes) of the {@link Uint32Array} relative to the
     ...
     * @return the newly created {@link Uint32Array} or null if it isn't
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Uint32Array} is created using the byteOffset and length to
     * specify the start and end (in bytes) of the {@link Uint32Array} relative
    ...
    /**
     * Creates a new instance of the {@link Uint32Array} of the given length in
    ...
    /**
     * Creates a new instance of the {@link Uint32Array} of the length of the
     * given array in values. The values contained in the given array are set to
     * the newly created {@link Uint32Array}.
     * 
     * @param array
     ...
     * {@link Uint32Array#create(int[])}). Please note that in production mode
     * int, short and byte are handled as 64Bit floating point values, so you
     * can use them for values >2^31-1. Keep in mind that not every long value
     * can be represented exactly by 64Bit floating values. Be aware that this
     * won't work correctly in dev mode and no literals above that limit are
     * supported in Java.
     * 
     * @param array
     *            the array to get the values from
    ...
    /**
     * Creates a new instance of the {@link Uint32Array} of the same length (in
     * values) as the given {@link Uint32Array} using a new ArrayBuffer. The new
     * {@link TypedArray} is initialized with the values of the given
     ...
     *            (multiple of the value length of this {@link TypedArray})
     * @param length
     *            the length of the {@link Uint32Array} in vales.
     * @return the newly created {@link Uint32Array}.
     */
    private static native Uint32Array createImpl(ArrayBuffer buffer,
