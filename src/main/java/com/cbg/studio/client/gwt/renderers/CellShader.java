...
public class CellShader extends JavaScriptObject {
     ...
     * 
     * THREEx.UniformsLib['cel'] = { "uDirLightPos" : { type: "v3", value: new
     * THREE.Vector3(1,0,0) }, "uDirLightColor" : { type: "c" , value: new
     * THREE.Color( 0xeeeeee ) }, "uAmbientLightColor" : { type: "c" , value:
     * new THREE.Color( 0x050505 ) }, "uBaseColor" : { type: "c" , value: new
     * THREE.Color( 0xff0000 ) } };
     * 
     * THREEx.ShaderLib['cel'] = { vertexShader: [ "varying vec3 vNormal;",
