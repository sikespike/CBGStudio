...
public class Quaternion extends JavaScriptObject {
    ...
    public final native Quaternion multiplyQuaternions(Quaternion a,
            Quaternion b)/*-{
    ...
    public static native final Quaternion slerp(Quaternion qa, Quaternion qb,
            Quaternion qm, double t)/*-{
