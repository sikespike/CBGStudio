...
/**
 * Utility class to convert Java arrays to JsArrays of matching types (and the
 * other way around). The methods take care of the scope (dev mode vs.
 * production mode).
 * 
 */
public final class JsArrayUtil {
    ...
    /**
     * Reads a long value from a {@link JsArrayInteger}. Pay attention: Avoid
     * using long values in GWT if possible (
     * {@link "http://code.google.com/intl/de-DE/webtoolkit/doc/latest/DevGuideCodingBasicsCompatibility.html#language"}
     * ). This method has poor performance compared with reading int values
     * directly from the {@link JsArrayInteger}.
     * 
     * @param array
     *            the array to get the value from.
     * @param index
     *            the index to get he value from the array
     ...
     *            the array to get the value from
     * @param index
     *            the index to get the value from the array
     * @return the value as String
     */
    public static native String getStringFromJsArrayInteger(
            JsArrayInteger array, int index) /*-{
                                             return "" + array[index];
                                             }-*/;

    /**
     * Sets a long value to a JsArrayInteger. Pay attention: Avoid using long
     * values in GWT if possible (
     * {@link "http://code.google.com/intl/de-DE/webtoolkit/doc/latest/DevGuideCodingBasicsCompatibility.html#language"}
     * ). This method has poor performance compared with writing int values
     * directly to the {@link JsArrayInteger}.
     * 
     * @param array
     *            the array to set the value
     * @param index
     *            the index to set the value at
     * @param value
     *            the value to set
     */
    public static void setLongToJsArrayInteger(JsArrayInteger array, int index,
            long value) {
     ...
     *            the value to set
     */
    public static native void setStringToJsArrayInteger(JsArrayInteger array,
     ...
     */
    private static native JsArrayBoolean arrayAsJsArrayForProdMode(
            boolean[] array) /*-{
                             return array;
                             }-*/;
     ...
     */
    private static native JsArrayInteger createArrayFromString(
            String arrayString) /*-{
    ...
    /**
     * Private constructor. Class only contains static utility methods and must
     * not be instantiated.
     */
    private JsArrayUtil() {
    }
