...
/**
 * 
 * A DataView is an {@link ArrayBufferView} with no concrete type to read and
 * write values. The DataView provides read and write methods for all types
 * supported by the {@link TypedArray}s.
 * 
 */
public class DataView extends ArrayBufferView {
     ...
     * 
     * @param buffer
     *            the underlying {@link ArrayBuffer}.
     * @return the newly created DataView or null if it isn't supported by the
     *         browser
     */
     ...
     *            the underlying {@link ArrayBuffer}.
     * @param byteOffset
     *            the byteOffset of the DataView relative to the start of the
     *            underlying {@link ArrayBuffer}.
     ...
     *            underlying {@link ArrayBuffer}.
     * @param length
     *            the length of the DataView in bytes.
     * @return the created DataView or null if it isn't supported by the browser
     */
    ...
    /**
     * Checks if the Browser supports the {@link DataView}. There's a special
     * check, as not all browsers that do support {@link TypedArray} support
     * {@link DataView} too. Thats because {@link DataView} is a late addition
    ...
    /**
     * Checks at runtime if the Browser supports the {@link DataView}. There's a
     * special check, as not all browsers that do support {@link TypedArray}
     * support {@link DataView} too. Thats because {@link DataView} is a late
     ...
     * 
     * @param byteOffset
     *            the byte offset from the start of the DataView.
     ...
     *            the byte offset from the start of the DataView.
     * @param littleEndian
     *            flag, if the value should be read as little endian.
     * @return the Float32 value at the given byteOffset
     */
     ...
     *            the byte offset from the start of the DataView.
     * @param littleEndian
     *            flag, if the value should be written as little endian.
     * @param value
     *            the value to set
     */
    public final native void setFloat32(int byteOffset, float value,
