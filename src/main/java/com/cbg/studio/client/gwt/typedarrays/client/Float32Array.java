...
public class Float32Array extends TypedArray<Float32Array> {
    ...
    /**
     * Creates a new instance of the {@link Float32Array} using the given
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * @param buffer
     *            the underlying {@link ArrayBuffer} of the newly created
     *            {@link TypedArray}.
     * @return the created {@link Float32Array} or null if it isn't supported by
     *         the browser.
     */
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Float32Array} is created using the byteOffset to specify the
     * starting point (in bytes) of the {@link Float32Array} relative to the
     ...
     * @return the newly created {@link Float32Array} or null if it isn't
     ...
     * {@link ArrayBuffer} to read/write values from/to.
     * 
     * The {@link Float32Array} is created using the byteOffset and length to
     * specify the start and end (in bytes) of the {@link Float32Array} relative
    ...
    /**
     * Creates a new instance of the {@link Float32Array} of the length of the
     * given array in values. The values contained in the given array are set to
     * the newly created {@link Float32Array}.
     * 
     * @param array
    ...
    /**
     * Creates a new instance of the {@link Float32Array} of the given length in
    ...
    /**
     * Creates a new instance of the {@link Float32Array} of the same length (in
     * values) as the given {@link Float32Array} using a new ArrayBuffer. The
     ...
     *            (multiple of the value length of this {@link TypedArray})
     * @param length
     *            the length of the {@link Float32Array} in vales.
     * @return the newly created {@link Float32Array}.
     */
    private static native Float32Array createImpl(ArrayBuffer buffer,
