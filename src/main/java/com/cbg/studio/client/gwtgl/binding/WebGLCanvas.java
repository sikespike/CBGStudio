 ...
 * the License.
 */
package com.cbg.studio.client.gwtgl.binding;
...
/**
 * Canvas widget to support WebGL rendering. To render on the widget using
 * WebGL, you can request the WebGLRendering context by calling getGlContext().
 * 
 */
@Deprecated
public class WebGLCanvas extends FocusWidget {
     ...
     * 
     * @param width
     *            the width of the {@link WebGLCanvas}
     * @param height
     *            the height of the {@link WebGLCanvas}
     */
    ...
    /**
     * Constructs a WebGLCanvas with width=200px and height=200px using the
     * given contextAttributes.
     * 
     * @param contextAttributes
     *            the {@link WebGLContextAttributes} used to construct the
    ...
    /**
     * Constructs a WebGLCanvas with the given width, height and the
     * contextAttributes.
     * 
     * @param contextAttributes
     *            the {@link WebGLContextAttributes} used to construct the
     ...
     *            the height of the {@link WebGLCanvas}
     */
    public WebGLCanvas(WebGLContextAttributes contextAttributes, String width,
            String height) {
