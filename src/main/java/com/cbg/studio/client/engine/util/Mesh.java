package com.cbg.studio.client.engine.util;
...
public class Mesh {
     ...
     * 
     * @param numVerticesElements
     *            number of vertices floats
     * @param numTexCoordsElements
     *            number of tex coords floats
     * @param numVertexNormalsElements
     *            number of vertex normals floats
     */
    public Mesh(int numVerticesElements, int numTexCoordsElements,
            int numVertexNormalsElements) {
    ...
    /**
     * Adds a Mesh to this Mesh, resulting in a Mesh consisting of all the data
     * of the two Meshes
     * 
     * @param other
     *            Mesh to add
    ...
    public Mesh add(Mesh other) {
        Mesh result = new Mesh(this.verticesArray.length
                + other.verticesArray.length, this.texCoordsArray.length
                + other.texCoordsArray.length, this.vertexNormalsArray.length
                + other.vertexNormalsArray.length);
